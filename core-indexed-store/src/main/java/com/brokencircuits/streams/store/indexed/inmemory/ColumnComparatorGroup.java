...
public class ColumnComparatorGroup<K, V> {
  ...
  @Getter(AccessLevel.PACKAGE)
  private final com.brokencircuits.streams.store.indexed.ComparatorGroupType type;

  public static <K, V> Builder<K, V> newBuilder(
      ComparatorGroupType type) {
  ...
  public static class Builder<K, V> {
    ...
    public Builder<K, V> compareKey(ColumnDetails<K> column, Object value) {
      keyComparators.add(new ColumnComparator<>(column, value));
      return this;
    }

    public Builder<K, V> value(ColumnDetails<V> column, Object value) {
      valueComparators.add(new ColumnComparator<>(column, value));
      return this;
    }
    ...
    public Builder<K, V> childGroupOr(Consumer<Builder<K, V>> childBuilder) {
      Builder<K, V> b = new Builder<>(ComparatorGroupType.OR);
      childBuilder.accept(b);
      children.add(b.build());
      return this;
    }
